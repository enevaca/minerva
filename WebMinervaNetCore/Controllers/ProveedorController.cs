...
namespace WebMinervaNetCore.Controllers
{
    ...
    public class ProveedorController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var proveedores = JsonSerializer.Deserialize<List<ProveedorCustom>>(response.Content);

            //return View(await _context.Proveedors.Where(x => x.RegistroActivo == true).ToListAsync());
